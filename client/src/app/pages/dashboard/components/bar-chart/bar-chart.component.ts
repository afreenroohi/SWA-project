...
export class BarChartComponent implements OnInit {
  ...
  @Input('barChartHeading') heading : string = 'Spent Analysis by the department'
  @Input('barChartData') data :  ChartConfiguration<'bar'>['data'] = {
    labels: [],
    datasets: []
  }
  @Input('barChartOptions') options: ChartConfiguration<'bar'>['options'] = {
    responsive: true,
    plugins: {
      legend: {
        display: false,
