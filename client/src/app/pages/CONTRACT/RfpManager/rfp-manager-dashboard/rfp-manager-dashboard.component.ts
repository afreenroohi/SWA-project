...
@Component({
  selector: 'app-rfp-manager-dashboard',
  templateUrl: './rfp-manager-dashboard.component.html',
  styleUrls: ['./rfp-manager-dashboard.component.scss']
})
export class RfpManagerDashboardComponent implements OnInit {
  ...
  getContractList() {
    let contractStatus = '';
    if (this.optionSelected == "ContAppr") {
      contractStatus = "RRMA"
    } else if (this.optionSelected == "rmi") {
      contractStatus = "RRMR"
    }
  ...
  showDetails(award_number: any, project_name: any) {
    if (this.optionSelected == "ContAppr") {
      // this.router.navigate(['contract/RfpManagerDetails'], {
      //   state: {
