...
@Component({
  selector: 'app-rfp-manager-details',
  templateUrl: './rfp-manager-details.component.html',
  styleUrls: ['./rfp-manager-details.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RfpManagerDetailsComponent implements OnInit {
  ProxyUserId = 'TSUDHA';
  constructor(
