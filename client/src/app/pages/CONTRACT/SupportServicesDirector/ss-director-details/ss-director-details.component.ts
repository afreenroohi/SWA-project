...
@Component({
  selector: 'app-ss-director-details',
  templateUrl: './ss-director-details.component.html',
  styleUrls: ['./ss-director-details.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SsDirectorDetailsComponent implements OnInit {
  ProxyUserId = 'TSUDHA';
  constructor(
