...
// Component for contract details for contract manager (approval screens)
@Component({
  selector: 'app-contract-manager-details',
  templateUrl: './contract-manager-details.component.html',
  styleUrls: ['./contract-manager-details.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ContractManagerDetailsComponent implements OnInit {
