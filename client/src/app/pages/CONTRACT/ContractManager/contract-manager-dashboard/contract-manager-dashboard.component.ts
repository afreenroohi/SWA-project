...
// list for contract manager page
@Component({
  selector: 'app-contract-manager-dashboard',
  templateUrl: './contract-manager-dashboard.component.html',
  styleUrls: ['./contract-manager-dashboard.component.scss']
})
export class ContractManagerDashboardComponent implements OnInit {
  ProxyUserId = 'TSUDHA';
  constructor(
  ...
  // get call for list of contracts
  getContractList() {
    let contractStatus = 'PCMA';
    let status = {
  ...
  // redirection to detail page function call
  showDetails(award_number: any, project_name: any) {
    // this.router.navigate(['contract/ContractManagerDetails'], {
    //   state: {
