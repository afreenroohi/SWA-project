...
@Component({
  selector: 'app-vp-cor-serv-dashboard',
  templateUrl: './vp-cor-serv-dashboard.component.html',
  styleUrls: ['./vp-cor-serv-dashboard.component.scss']
})
export class VpCorServDashboardComponent implements OnInit {
  ProxyUserId = 'TSUDHA';
  constructor(
  ...
  showDetails(award_number: any, project_name: any) {
    this.router.navigate(['contract/VpCorServDetails'], {
      state: {
