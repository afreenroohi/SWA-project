...
@Component({
  selector: 'app-chairman-dashboard-eval',
  templateUrl: './chairman-dashboard.component.html',
  styleUrls: ['./chairman-dashboard.component.scss']
})
export class BEChairmanDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.committeeRole = this.commonService.getUserRoleBasedOnCmtID(this.committeeId);
