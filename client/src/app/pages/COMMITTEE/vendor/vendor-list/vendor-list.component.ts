...
import { listOfColumnVendorList } from 'src/app/shared/shared';
...
export class VendorListComponent implements OnInit {
  ...
  @Input() CommitteeAction: any = 'VNDT';
  @Input() Status: any = 'VDNT';
  
  @Input() OptionSelected: any = 'vendorlist';
  
  
  listOfColumn = listOfColumnVendorList;
