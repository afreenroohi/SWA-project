...
@Component({
  selector: 'app-bidsfinanceoffermember',
  templateUrl: './bidsfinanceoffermember.component.html',
  styleUrls: ['./bidsfinanceoffermember.component.scss']
})
export class BidsFinanceOfferMemberComponent implements OnInit {
