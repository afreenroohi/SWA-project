...
@Component({
  selector: 'app-bidsfinanceoffer',
  templateUrl: './bidsfinanceoffer.component.html',
  styleUrls: ['./bidsfinanceoffer.component.scss']
})
export class BidsfinanceofferComponent implements OnInit {
