...
@Component({
  selector: 'app-bidstobapproved-dashboard',
  templateUrl: './bidstobapproved-dashboard.component.html',
  styleUrls: ['./bidstobapproved-dashboard.component.scss']
})
export class BidstobapprovedDashboardComponent implements OnInit {
  ...
  constructor( private api :ApiService,
    ...
    ngOnInit(): void {
      ...
      //this.commonService.bidsToBeApproved = 60;
    }
